...
exports.upsertSingleColumn = upsertSingleColumn;
const serverless_1 = require("@neondatabase/serverless");
// ⚡ Initialize Neon once, outside function
const sql = (0, serverless_1.neon)(process.env.DATABASE_URL);
async function saveToDatabase(reqid, cleaned, translationResult, analysisResult, specificReqId) {
...
====================================================
*/
async function upsertSingleColumn(reqid, column, value) {
    ...
    `;
        console.log(`📝 [DB_SINGLE_UPSERT] ${targetTable}.${column} updated for reqid=${reqid}`);
    }
    catch (err) {
        console.error(`❌ [DB_SINGLE_UPSERT_ERROR] reqid=${reqid}: ${err.message}`);
        throw err;
    }
}
