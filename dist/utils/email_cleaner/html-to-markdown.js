...
exports.htmlToPlainText = htmlToMarkdown;
exports.extractLatestThread = extractLatestThread;
exports.removeSignature = removeSignature;
exports.removeDisclaimers = removeDisclaimers;
exports.extractPrePostText = extractPrePostText;
 ...
 * ------------------------------- */
function postProcessMarkdown(text, config) {
    let cleaned = text
 ...
 * ------------------------------- */
function extractLatestThread(text) {
    if (!text)
        return "";
...
function findLastTableEnd(lines) {
    let inTable = false;
    let lastTableLine = -1;
...
function removeSimpleSignature(text) {
    const lines = text.split("\n");
 ...
 * ------------------------------- */
function extractPrePostText(text) {
    if (!text)
